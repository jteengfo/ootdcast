    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cloting_items', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Outfit',
            fields=[
                ...
                ('formality', models.CharField(max_length=50)),
                ('clothing_items', models.ManyToManyField(related_name='outfits', to='ootdcastapp.clothingitem')),
